...
#programs
pacman -S --noconfirm netctl grub os-prober mtools dhcpcd vim git make alsa-firmware wget xorg-server pulseaudio xorg-xinit curl tar libxft mc fakeroot binutils patch pkgconf base-devel
# Set date time

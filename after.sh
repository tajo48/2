...
#programs
pacman -S --noconfirm grub os-prober dmenu mtools dhcpcd vim git make wget xorg-server pulseaudio xorg-xinit curl tar libxft mc fakeroot binutils patch pkgconf base-devel
# Set date time
